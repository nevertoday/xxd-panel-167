---
name: xxd-panel-167
description: "Create Panel 167 raster artwork: Centred Wave-form Raised-ink Relief. Use when the user invokes xxd-panel-167 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-167/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-167-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
