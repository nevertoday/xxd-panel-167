...
# XXD Panel 167｜موجة مركزية بملمس حبر بارز
...
ثمانية نماذج أولية من Panel 167، وُلّد كل منها مستقلاً من صورة مصدر مختلفة مع نص إنجليزي قصير. الأفقي 1536×864 بنصفين متساويين يميناً ويساراً؛ والعمودي 1152×1536 بنصفين متساويين أعلى وأسفل.

رُوجعت صلة الصور بالمصادر والتكوين الموجي وملمس الحبر البارز. سيارة 05 واقعية ومعدنية، و06 كثير التفاصيل، و09 و12 يحتفظان بمشاهد واسعة. تمتد موجات عديدة إلى الحواف فلا تترك فراغاً واسعاً من كل الجهات، وبعض الألوان باهتة. هذه نتائج أولية فعلية ولم تجتز كلها مراجعة الأسلوب.
...
موجة تجريدية مركزية تحمل الموضوع دون اشتراط البحر، بملمس حبر سميك محبب وضوء جانبي خفيف وفراغ كبير.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 167 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-167`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-167 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-167-prompt.en.md) أو [بالصينية](references/xxd-panel-167-prompt.zh-CN.md).
